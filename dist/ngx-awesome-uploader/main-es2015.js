...
let FileComponent = class FileComponent {
        ...
        if (!this.globalDisable && !this.disableIf) {
            ...
            for (let i = 0; i < length; i++) {
                ...
                if (!entry) {
                    ...
                    if (file) {
                        ...
                        const toUpload = new _upload_file_model__WEBPACK_IMPORTED_MODULE_2__["UploadFile"](fakeFileEntry.name, fakeFileEntry);
                        this.addToQueue(toUpload);
                    }
                }
                else {
                    if (entry.isFile) {
                        const toUpload = new _upload_file_model__WEBPACK_IMPORTED_MODULE_2__["UploadFile"](entry.name, entry);
                        this.addToQueue(toUpload);
                    }
            ...
            this.subscription = timerObservable.subscribe(t => {
                if (this.files.length > 0 && this.numOfActiveReadEntries === 0) {
                    this.onFileDrop.emit(new _upload_event_model__WEBPACK_IMPORTED_MODULE_3__["UploadEvent"](this.files));
                    this.files = [];
                }
            });
        }
    ...
    traverseFileTree(item, path) {
        if (item.isFile) {
            const toUpload = new _upload_file_model__WEBPACK_IMPORTED_MODULE_2__["UploadFile"](path, item);
...
let FileDropModule = class FileDropModule {
};
...
let FilePickerComponent = class FilePickerComponent {
    ...
    handleFiles(files) {
        ...
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["combineLatest"])(...asyncFunctions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(res => {
    ...
    validateFileAsync(file) {
        ...
        return this.customValidator(file).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(res => {
            if (!res) {
    ...
    handleInputFile(file, index) {
        const type = Object(_file_upload_utils__WEBPACK_IMPORTED_MODULE_2__["getFileType"])(file.type);
...
let FilePreviewContainerComponent = class FilePreviewContainerComponent {
    constructor() {
...
let FilePreviewItemComponent = class FilePreviewItemComponent {
...
let RefreshIconComponent = class RefreshIconComponent {
    constructor() {
...
let PreviewLightboxComponent = class PreviewLightboxComponent {
    constructor(sanitizer) {
        this.sanitizer = sanitizer;
...
let CloudIconComponent = class CloudIconComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
class DemoFilePickerAdapter extends projects_file_picker_src_lib_file_picker_adapter__WEBPACK_IMPORTED_MODULE_2__["FilePickerAdapter"] {
    constructor(http) {
        super();
        this.http = http;
    }
    uploadFile(fileItem) {
        ...
        const req = new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpRequest"]('POST', api, form, { reportProgress: true });
...
DemoFilePickerAdapter.ctorParameters = () => [
...
let DemoFilePickerComponent = class DemoFilePickerComponent {
    constructor(http) {
        this.http = http;
    ...
    myCustomValidator(file) {
        ...
        if (file.size > 50) {
            return this.http.get('https://vugar.free.beeceptor.com').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])((res) => res === 'OK'));
        }
...
DemoFilePickerComponent.ctorParameters = () => [
