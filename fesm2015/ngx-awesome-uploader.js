...
class CropperOptionsModel {
     ...
     * @param {?} __0
     */
    constructor({ aspectRatio = 1, maintainAspectRatio = true, resizeToWidth = 0, resizeToHeight = 0, cropperStaticWidth = 0, cropperStaticHeight = 0, cropperMinWidth = 0, cropperMinHeight = 0, initialStepSize = 3, onlyScaleDown = false, roundCropper = false, imageQuality = 92, alignImage = 'center', backgroundColor = '', hideResizeSquares = false, disabled = false, canvasRotation = 0, transform = {}, loadImageFailed = (/**
     * @return {?}
     */
    () => { }) }) {
