(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    if (false) {
        ...
        /** @type {?|undefined} */
        CropperOptions.prototype.loadImageFailed;
    }
    var CropperOptionsModel = /** @class */ (function () {
        function CropperOptionsModel(_a) {
            var _b = _a.aspectRatio, aspectRatio = _b === void 0 ? 1 : _b, _c = _a.maintainAspectRatio, maintainAspectRatio = _c === void 0 ? true : _c, _d = _a.resizeToWidth, resizeToWidth = _d === void 0 ? 0 : _d, _e = _a.resizeToHeight, resizeToHeight = _e === void 0 ? 0 : _e, _f = _a.cropperStaticWidth, cropperStaticWidth = _f === void 0 ? 0 : _f, _g = _a.cropperStaticHeight, cropperStaticHeight = _g === void 0 ? 0 : _g, _h = _a.cropperMinWidth, cropperMinWidth = _h === void 0 ? 0 : _h, _j = _a.cropperMinHeight, cropperMinHeight = _j === void 0 ? 0 : _j, _k = _a.initialStepSize, initialStepSize = _k === void 0 ? 3 : _k, _l = _a.onlyScaleDown, onlyScaleDown = _l === void 0 ? false : _l, _m = _a.roundCropper, roundCropper = _m === void 0 ? false : _m, _o = _a.imageQuality, imageQuality = _o === void 0 ? 92 : _o, _p = _a.alignImage, alignImage = _p === void 0 ? 'center' : _p, _q = _a.backgroundColor, backgroundColor = _q === void 0 ? '' : _q, _r = _a.hideResizeSquares, hideResizeSquares = _r === void 0 ? false : _r, _s = _a.disabled, disabled = _s === void 0 ? false : _s, _t = _a.canvasRotation, canvasRotation = _t === void 0 ? 0 : _t, _u = _a.transform, transform = _u === void 0 ? {} : _u, _v = _a.loadImageFailed, loadImageFailed = _v === void 0 ? (/**
             * @return {?}
             */
            function () { }) : _v;
    ...
    if (false) {
        ...
        /** @type {?} */
        CropperOptionsModel.prototype.loadImageFailed;
    }
    ...
    var FilePickerComponent = /** @class */ (function () {
        function FilePickerComponent(fileService, ref) {
             ...
             */
            this.removeSuccess = new core.EventEmitter();
            /**
        ...
        function (files) {
            ...
            return rxjs.combineLatest.apply(void 0, __spread(asyncFunctions)).pipe(operators.map((/**
             * @param {?} res
             * @return {?}
             */
            function (res) {
        ...
        function (file) {
            ...
            return this.customValidator(file).pipe(operators.tap((/**
             * @param {?} res
             * @return {?}
             */
            function (res) {
        ...
        FilePickerComponent.propDecorators = {
            ...
            uploadFail: [{ type: core.Output }],
            removeSuccess: [{ type: core.Output }],
            validationError: [{ type: core.Output }],
            fileAdded: [{ type: core.Output }],
            customValidator: [{ type: core.Input }],
            enableCropper: [{ type: core.Input }],
            showeDragDropZone: [{ type: core.Input }],
            showPreviewContainer: [{ type: core.Input }],
            itemTemplate: [{ type: core.Input }],
            uploadType: [{ type: core.Input }],
            fileMaxSize: [{ type: core.Input }],
            fileMaxCount: [{ type: core.Input }],
            totalMaxSize: [{ type: core.Input }],
            accept: [{ type: core.Input }],
            fileExtensions: [{ type: core.Input }],
            cropperOptions: [{ type: core.Input }],
            adapter: [{ type: core.Input }],
            dropzoneTemplate: [{ type: core.Input }],
            captions: [{ type: core.Input }]
        };
    ...
    var FilePreviewItemComponent = /** @class */ (function () {
        function FilePreviewItemComponent(fileService) {
            ...
            this.uploadSuccess = new core.EventEmitter();
            this.uploadFail = new core.EventEmitter();
            this.imageClicked = new core.EventEmitter();
            this.icon = 'checkmark';
        }
        /**
         * @return {?}
    ...
    exports.FileValidationTypes = FileValidationTypes;
    exports.ɵa = FileDropModule;
    exports.ɵb = FileComponent;
    exports.ɵc = CloudIconComponent;
    exports.ɵd = FilePreviewContainerComponent;
    exports.ɵe = FilePreviewItemComponent;
    exports.ɵf = PreviewLightboxComponent;
    exports.ɵg = RefreshIconComponent;
    exports.ɵh = CloseIconComponent;
